...
Решение: есть удобный скрипт (точнее набор скриптов) [andrep/git-svn-clone-externals](git-svn-clone-externals) который облегчает линковку на дополнительные svn репозитории и обновление из них.
